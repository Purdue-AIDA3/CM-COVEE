...
embed_size = 64
modality = 'face' # (eeg,eye), (eeg,face), (eye,face) the order has to be correct !!!
...
model.load_state_dict(torch.load('/Users/sky/Desktop/Windracers/Transformer_Encoder_Test/' + ground_truth + '/' + model_name + '/model_' + modality + '.pt'))
